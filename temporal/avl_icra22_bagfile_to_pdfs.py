...
def generate_plots(pdf_variable, plot_number, axrray, i, arm_filter_param=3, hand_filter_param=3,
    ...
    :param pdf_variable: The variable for which we are creating the pdf, so we can compare all the plots easy
    :param plot_number: In order to know the place in the page of the pdf, where to put this plot
    ...
    :param target_label: Case or Label that we are searching for
    :return:
    """
    ...
    location = '/home/avl/PycharmProjects/appleProxy/bagfiles/'    # Alejo's laptop
...
# Target label. ******* Note: It has to be same as in function def look_at_labels ******
...
for pdf_variable in variables:
    ...
    for pick in range(1, n_picks + 1):
        ...
        try:
            ...
            # Plot stuff
            toss = generate_plots(pdf_variable, plot_number, axrray, pick, arm_filter_window,
