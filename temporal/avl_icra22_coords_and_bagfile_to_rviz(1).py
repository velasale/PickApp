...
def main():
    try:
        ...
        apples_and_picks = [(1, 1), (1, 2), (1, 3), (1, 4), (1, 5), (1, 6),
                            ...
                            (15, 43), (16, 44), (16, 45), (17, 46), (17, 47), (18, 48),
                            (22, 49), (19, 50), (20, 51), (23, 52), (26, 53), (27, 54),
                            (27, 55), (27, 56), (28, 57), (28, 58), (28, 59), (28, 60),
                            (29, 61), (30, 62), (30, 63), (31, 64), (33, 65), (32, 66),
                            (32, 67), (34, 68), (34, 69), (34, 70), (35, 71), (37, 72),
                            (38, 73), (39, 74), (40, 75), (41, 76), (42, 77)]
        ...
        for pick in apples_and_picks:
            ...
            print('Apple %i during pick %i' % ((apple + 1), pick_number))
            ...
            calix_to_hand = apple_proxy_experiment.object_to_hand(p1)           # apple's calix
            ...
            objects_in_hand.append([apple_to_hand, calix_to_hand, stem_to_hand, orig_to_hand, grav_to_hand])
